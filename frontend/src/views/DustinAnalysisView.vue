    ...
    <v-row>
      <v-col cols="12">
        <h1 class="text-h4 mb-6">
          ...
          Dustin Nisley - Overhead Coverage Analysis
        </h1>
      </v-col>
    </v-row>
        ...
        <v-col cols="12" md="3">
          <v-card>
            <v-card-text>
              ...
              <div class="text-body-2 mt-2">Dustin's revenue to company</div>
            </v-card-text>
          </v-card>
        </v-col>
...
import DustinOverheadChart from '../components/charts/DustinOverheadChart.vue'
...
export default {
  ...
  setup() {
    ...
    const loadAnalysisData = async () => {
      ...
      try {
        const response = await analysisApi.getDustinOverheadAnalysis()
        ...
        console.error('Error loading Dustin analysis:', err)
